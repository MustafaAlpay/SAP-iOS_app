...
class MyPrefixPurchaseOrderHeadersMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
...
extension MyPrefixPurchaseOrderHeadersMasterViewController: EntitySetUpdaterDelegate {

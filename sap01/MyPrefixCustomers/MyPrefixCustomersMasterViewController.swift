...
class MyPrefixCustomersMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
...
extension MyPrefixCustomersMasterViewController: EntitySetUpdaterDelegate {

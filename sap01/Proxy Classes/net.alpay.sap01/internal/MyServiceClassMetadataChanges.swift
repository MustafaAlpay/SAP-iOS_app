...
internal class MyServiceClassMetadataChanges: ObjectBase {
    ...
    private class func merge1(metadata: CSDLDocument) {
        ...
        if !MyServiceClassMetadata.ActionImports.updateSalesOrderStatus.isRemoved {
            MyServiceClassMetadata.ActionImports.updateSalesOrderStatus = metadata.dataMethod(withName: "UpdateSalesOrderStatus")
        }

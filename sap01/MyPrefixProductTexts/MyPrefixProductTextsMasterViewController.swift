...
class MyPrefixProductTextsMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
...
extension MyPrefixProductTextsMasterViewController: EntitySetUpdaterDelegate {

...
class MyPrefixSalesOrderHeadersMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
...
extension MyPrefixSalesOrderHeadersMasterViewController: EntitySetUpdaterDelegate {

...
class MyPrefixSalesOrderItemsMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
...
extension MyPrefixSalesOrderItemsMasterViewController: EntitySetUpdaterDelegate {

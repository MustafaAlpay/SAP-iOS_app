...
class MyPrefixProductsMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
...
extension MyPrefixProductsMasterViewController: EntitySetUpdaterDelegate {

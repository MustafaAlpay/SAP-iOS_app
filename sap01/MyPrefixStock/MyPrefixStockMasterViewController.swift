...
class MyPrefixStockMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
...
extension MyPrefixStockMasterViewController: EntitySetUpdaterDelegate {

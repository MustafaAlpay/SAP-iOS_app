...
class MyPrefixProductCategoriesMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
...
extension MyPrefixProductCategoriesMasterViewController: EntitySetUpdaterDelegate {
